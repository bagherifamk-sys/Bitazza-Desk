...
- Name: widget-open-ticket-banner.spec.ts >> banner shows ticket category
- Location: e2e/widget-open-ticket-banner.spec.ts:27:1
...
Call log:
  - waiting for locator('.csbot-window') to be visible
  ...
  - generic [ref=e3]:
    - generic [ref=e4]:
      ...
      - generic [ref=e18]:
        ...
        - generic [ref=e26]:
          - button "🇬🇧 English" [disabled] [ref=e27] [cursor=pointer]
          - button "🇹🇭 ภาษาไทย" [disabled] [ref=e28] [cursor=pointer]
      - generic [ref=e29]:
        - textbox "Select a language / เลือกภาษา" [disabled] [ref=e30]
        - button "Send" [disabled] [ref=e31]:
          - img [ref=e32]
      - generic [ref=e34]: Powered by CS Bot
    - button "Open support chat" [active] [ref=e36] [cursor=pointer]:
      - img [ref=e38]
```
